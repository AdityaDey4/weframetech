...
export default function Home() {
  ...
  return (
    <div className="flex bg-white h-screen overflow-hidden">
      {/* Sidebar */}
      <div
        className={`fixed z-10 md:static top-0 left-0 h-full w-64 bg-[#11455D] text-white transform transition-transform duration-300
      ...
      <main className="flex-1 flex flex-col overflow-y-auto">
        {/* Header */}
        <header className="flex justify-end gap-4 p-4 pr-6 border-b border-gray-200">
